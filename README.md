...
<table>
  <tr>
    <td valign="top" width="50%">
      ...
      • <strong>Go (Golang)</strong> (Gin, REST APIs, Microservices)<br>
      • <strong>Python</strong> (FastAPI, Scraping, Automation)<br>
      • <strong>C# / .NET</strong> (Core, MVC, Desktop Applications)<br>
      • <strong>TypeScript & JavaScript</strong> (Next.js, React)
    </td>
    <td valign="top" width="50%">
      <strong>🛡️ Cybersecurity & DevSecOps</strong><br>
      • <strong>Vulnerability Auditing</strong> (Nmap, Nikto, Nuclei)<br>
      • <strong>Attack Surface Management</strong> (EASM tools, Recon)<br>
      • <strong>Security Architecture</strong> (CSP, CORS, HSTS configurations)<br>
